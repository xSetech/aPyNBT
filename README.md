  ...
  TAG_Compound                     1  2054B                     Data = 19 children
    ...
    TAG_Compound                   2  1768B                   Player = 28 children
      ...
      TAG_List                     3    38B                   Motion = 3 children of type TAG_Double
        <class 'float'>            4     8B          <class 'float'> = 4.9796312086493114e-55
        <class 'float'>            4     8B          <class 'float'> = -0.0784000015258789
        <class 'float'>            4     8B          <class 'float'> = -7.038076210318639e-55
      ...
      TAG_List                     3    24B                 Rotation = 2 children of type TAG_Float
        <class 'float'>            4     4B          <class 'float'> = 196.50099182128906
        <class 'float'>            4     4B          <class 'float'> = 3.1499271392822266
      TAG_Int                      3    14B                  XpLevel = 0
      TAG_Int                      3    12B                    Score = 0
      TAG_Byte                     3    12B                 Sleeping = 0
      TAG_List                     3    35B                      Pos = 3 children of type TAG_Double
        <class 'float'>            4     8B          <class 'float'> = 858.5151604084725
        <class 'float'>            4     8B          <class 'float'> = 89.62000000476837
        <class 'float'>            4     8B          <class 'float'> = -544.3398051110646
