  ...
  TAG_Compound                     1  2054B                     Data = 19 children
    ...
    TAG_Compound                   2  1768B                   Player = 28 children
      ...
      TAG_Compound                 3    63B                abilities = 5 children
        ...
        TAG_End                    4     1B                          =
      TAG_Float                    3    19B             FallDistance = b'\x00\x00\x00\x00'
      TAG_Short                    3    14B                DeathTime = 0
      TAG_Int                      3    14B                  XpTotal = 0
      TAG_List                     3    38B                   Motion = 3 children
        TAG_Double                 4     8B                  unknown = b'4\xa8k\x87\xc4al\xdd'
        TAG_Double                 4     8B                  unknown = b'\xbf\xb4\x12\x05\xc2\x8f\\)'
        TAG_Double                 4     8B                  unknown = b'\xb4\xb1A\xdf=\xf8\xa98'
      TAG_Int                      3    13B                   SpawnY = 114
      TAG_Short                    3    11B                   Health = 20
      TAG_Int                      3    13B                   SpawnZ = -456
      TAG_Float                    3    26B      foodSaturationLevel = b'\x00\x00\x00\x00'
      TAG_Int                      3    13B                   SpawnX = 725
      TAG_Short                    3     8B                      Air = 300
      TAG_Byte                     3    12B                 OnGround = 1
      TAG_Int                      3    16B                Dimension = 0
      TAG_List                     3    24B                 Rotation = 2 children
        TAG_Float                  4     4B                  unknown = b'CD\x80A'
        TAG_Float                  4     4B                  unknown = b'@I\x98h'
      TAG_Int                      3    14B                  XpLevel = 0
      TAG_Int                      3    12B                    Score = 0
      TAG_Byte                     3    12B                 Sleeping = 0
      TAG_List                     3    35B                      Pos = 3 children
        TAG_Double                 4     8B                  unknown = b'@\x8a\xd4\x1f\x0ck\x94\xab'
        TAG_Double                 4     8B                  unknown = b'@Vg\xae\x14\x80\x00\x00'
        TAG_Double                 4     8B                  unknown = b'\xc0\x81\x02\xb7\xeb\xbd\xf8J'
      TAG_Short                    3     9B                     Fire = -20
      TAG_Float                    3    10B                      XpP = b'\x00\x00\x00\x00'
      TAG_Int                      3    16B                foodLevel = 12
      TAG_Float                    3    26B      foodExhaustionLevel = b'@\x1b,\xc6'
      TAG_Short                    3    13B                 HurtTime = 0
      TAG_Short                    3    15B               AttackTime = 0
      TAG_List                     3  1277B                Inventory = 35 children
        TAG_Compound               4    36B                  unknown = 5 children
